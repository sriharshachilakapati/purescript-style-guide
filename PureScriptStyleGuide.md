...
Try to keep the bodies of the matchers to a single line if at all possible, or go up-to 2 lines. If the matcher body goes more than 3 lines, do the following:
